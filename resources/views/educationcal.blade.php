...
<!-- Page Header End -->
    ...
    <iframe src="https://www.investwell.in/updation/parameter/Calculator/par_sip_calculatorN.jsp" width="100%" height="900"></iframe>

<style>
/* Ensure iframe is responsive and not affected on mobile */


 iframe {
    
    width: 100%; /* Increases the iframe width */
...
@media (max-width: 768px) { /* Adjust breakpoint as necessary */
    .sip-calculator iframe {
        width: 120%; /* Increase width on mobile as well */
    }
}

    /* Optional: Add styles to ensure other elements are responsive */
    .sip-calculator {
