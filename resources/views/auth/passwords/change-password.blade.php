...
<head>
    ...
    <style>
        ...
        /* Minimal additions for password requirements */
        .pw-hint {
            font-size: 12px;
            color: #666;
            margin-top: 4px;
...
<body>
    <div class="container">
        ...
        <form method="POST" action="/change-password" onsubmit="return validatePassword()">
            ...
            <div class="form-group">
                ...
                <div class="pw-hint">(Must be 8+ characters with uppercase, lowercase, number, and special character)</div>
            </div>
    ...
    <script>
        function validatePassword() {
            ...
            // Password requirements check (8+ chars, upper, lower, number, special)
