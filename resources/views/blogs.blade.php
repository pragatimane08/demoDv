        ...
        <div class="row justify-content-center mb-5 pb-2">
            ...
            <div class="col-md-6 col-lg-4 ftco-animate">
              <div class="blog-entry">
                <a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('img/image_1.jpg');">
...
<p class="mb-0">
                      <a href="{{ route('blogsingle') }}" class="btn custom-outline-btn">Read More <span class="ion-ios-arrow-round-forward"></span></a>
                    </p>
            ...
            <div class="col-md-6 col-lg-4 ftco-animate">
              <div class="blog-entry">
                <a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('img/image_2.jpg');">
                                  <div class="meta-date text-center p-2">
                    <span class="day">26</span>
                    <span class="mos">June</span>
                    <span class="yr">2019</span>
                ...
                <div class="text bg-white p-4">
                  ...
                  <div class="d-flex align-items-center mt-4">
                    <p class="mb-0">
                      <a href="#" class="btn custom-outline-btn">Read More <span class="ion-ios-arrow-round-forward"></span></a>
                    </p>
            ...
            <div class="col-md-6 col-lg-4 ftco-animate">
              <div class="blog-entry">
                <a href="blog-single.html" class="block-20 d-flex align-items-end" style="background-image: url('img/image_3.jpg');">
                                  <div class="meta-date text-center p-2">
                    <span class="day">26</span>
                    <span class="mos">June</span>
                    <span class="yr">2019</span>
                ...
                <div class="text bg-white p-4">
                  ...
                  <div class="d-flex align-items-center mt-4">
                      <p class="mb-0">
                        <a href="#" class="btn custom-outline-btn">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
                      <p class="ms-auto mb-0">
                        <a href="#" class="admin-link">Admin</a>
                        <!-- <a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a> -->
                      </p>
