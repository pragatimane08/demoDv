        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle {{ request()->routeIs('financial-calculator') || request()->routeIs('blogs') || request()->routeIs('learning') ? 'active' : '' }}" data-bs-toggle="dropdown">Investor Zone</a>
                        <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                    ...
                    <a href="{{ route('downloads') }}" class="nav-item nav-link {{ request()->routeIs('downloads') ? 'active' : '' }}">Downloads</a>
