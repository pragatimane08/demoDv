...
<!-- Page Header End -->
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="text-custom uppercase mb-2">Meet The Team</h1>
                <h1 class="display-6 mb-4"> Our Director</h1>
            </div>


            <div class="row g-0 team-items">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative" onclick="openPopup('popup-card-1')">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/img-1.webp" alt="">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="mt-2">VH Bhaskaran</h5>
                            <span>Director</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative" onclick="openPopup('popup-card-2')">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/resize.png" alt="">
                            <div class="team-social text-center">
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i
                                        class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative" onclick="openPopup('popup-card-3')">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/image3.webp" alt="">
                            <div class="team-social text-center">
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i
                                        class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="mt-2">V Krishna Dassan</h5>
                            <span>Director, Wealth Management</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative" onclick="openPopup('popup-card-4')">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/img-4.webp" alt="">
                            <div class="team-social text-center">
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i
                                        class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-outline-primary border-2 m-1" href=""><i
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="mt-2">Balaji S</h5>
                            <span>Vice President, Wealth Management </span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Pop-up Cards -->
    <div id="popup-card-1" class="popup-card">
        <div class="popup-content">
            <span class="close-btn" onclick="closePopup()">&times;</span>
            <img src="img/img-1.webp" alt="VH Bhaskaran" class="profile-pic-popup">
            <h2>VH Bhaskaran</h2>
            <p>Designation: Director</p>
            <p>Years of Experience: 40 years of experience in Equities, Pan India Business Development, Fund Raising for
                VC/PE Funds, Startups & Real Estate Companies.</p>
            <p>Organisational Experience - Sun Capital, Emkay, IndiaNivesh</p>
            <div class="team-social popup-social-icons">
    ...
    <div id="popup-card-2" class="popup-card">
        <div class="popup-content">
            <span class="close-btn" onclick="closePopup()">&times;</span>
            <img src="img/img-2.png" alt="G Devanathan" class="profile-pic-popup">
            <h2>G Devanathan</h2>
            <p>Designation: Director</p>
    ...
    <div id="popup-card-3" class="popup-card">
        <div class="popup-content">
            <span class="close-btn" onclick="closePopup()">&times;</span>
            <img src="img/image3.webp" alt="V Krishna Dassan" class="profile-pic-popup">
    ...
    <div id="popup-card-4" class="popup-card">
        <div class="popup-content">
            <span class="close-btn" onclick="closePopup()">&times;</span>
            <img src="img/img-4.webp" alt="Balaji S " class="profile-pic-popup">
            <h2>Balaji S </h2>
